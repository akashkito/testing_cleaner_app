...
//           //     showSearch(
//           //         context: context,
//           //         delegate: AppSearchDelegate(onSearch: (query) {
//           //           setState(() {
//           //             searchQuery = query;
//           //             filterApps();
//           //           });
...
class _AppsPageState extends State<AppsPage> with SingleTickerProviderStateMixin {
  ...
  // Fetch all installed apps, including system apps and hidden apps
  // Future<void> getInstalledApps() async {
  //   try {
  //     final bool isPermissionGranted =
  //         await platform.invokeMethod('isUsagePermissionGranted');
...
// // Inside the build method (in the AppBar or wherever you're displaying the total size):
