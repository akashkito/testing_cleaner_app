...
//     setState(() {
//       // Log to see the data coming from the native side
//       print("Files received from native code: $files");

//       _fileItems = files.map((file) {
//         // Assuming that each file is an object with these properties
//         return FileItem(
//           name: file['name'],
//           size: file['size'],
//           icon: file['icon'],
...
//       // Log the number of files loaded into the list
//       print("Number of files loaded: ${_fileItems.length}");
